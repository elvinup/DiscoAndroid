...
public class KucoinApi {
    ...
    public KucoinConfig getConfig() {
        return config;
    }

    public void setConfig(KucoinConfig config) {
        this.config = config;
    }
    ...
    // ======= ======= ======= ======= ======= =======
    public JsonObject getUserInfo() throws KucoinApiException {
    ...
    public Set<String> getCoinsOf(String coin) {
        try {
            ...
            Log.d("KUCOIN UNCAUGHT", e.getMessage());
        } catch (KucoinApiException e) {
            Log.d("KUCOIN ERROR {}", e.getMessage());
        }
