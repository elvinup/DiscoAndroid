...
public class KucoinOrderBook {
    ...
    public KucoinSymbol getSymbol() {
        return symbol;
    }

    public void setSymbol(KucoinSymbol symbol) {
        this.symbol = symbol;
    }

    public List<KucoinOrderBookLine> getSells() {
        return sells;
    }

    public void setSells(List<KucoinOrderBookLine> sells) {
        this.sells = sells;
    }

    public List<KucoinOrderBookLine> getBuys() {
        return buys;
    }

    public void setBuys(List<KucoinOrderBookLine> buys) {
        this.buys = buys;
    }
